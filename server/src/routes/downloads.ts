...
export function mountDownloadRoutes(app: Express) {
  ...
  app.get('/api/models/download/progress', async (req: Request, res: Response) => {
    try {
  ...
  app.get('/api/models/download/progress/:model', async (req: Request, res: Response) => {
    try {
  ...
  app.delete('/api/models/download/:model', async (req: Request, res: Response) => {
    try {
      const model = req.params.model;
